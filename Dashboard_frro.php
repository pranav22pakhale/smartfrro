      ...
      <div class="row">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                    ...
                    require_once 'database_connection.php';
                      $sql='SELECT id FROM registration where verification="unverified"';
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                <?php
                    ...
                    require_once 'database_connection.php';
                      $sql='SELECT id FROM registration where verification="verified"';
                      $result = mysqli_query($con, $sql);
                      $row_count=mysqli_num_rows($result);
                      // output data of each row
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box" onClick="window.location.href='frro_dashboard_tables/frro_awaiting_police_enquiry.php';"style="cursor: pointer;">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Awaiting Police<br>Enquiry</span>
              <span class="info-box-number">
                <?php

                    require_once 'database_connection.php';
                      $sql='SELECT id FROM registration where police_enquiry="requested"';
                      $result = mysqli_query($con, $sql);
                      $row_count=mysqli_num_rows($result);
                      // output data of each row
...
<div class="col-md-3 col-sm-6 col-xs-6">
          <div class="info-box" onClick="window.location.href='alert_mail/visa_expiry_mail.php';"style="cursor: pointer;">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Expiry 15 days</span>
              <span class="info-box-number"> <?php
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Unverified</span>
 ...
 ?>%"></div>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Verified</span>
 ...
 ?>%"></div>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Awaiting Enquiry</span>
                    <span class="progress-number"><b>
                     <?php
                    require_once 'database_connection.php';
                      $sql='SELECT id FROM registration where police_enquiry="requested"';
...
<?php
  require_once 'database_connection.php';
                      $sql='SELECT id FROM registration where purpose="education"';
                      $result = mysqli_query($con, $sql);
                      $row_count=mysqli_num_rows($result);
                      $purposeObj->education=$row_count;

                       $sql='SELECT id FROM registration where purpose="journalism"';
                      $result = mysqli_query($con, $sql);
                      $row_count=mysqli_num_rows($result);
                      $purposeObj->journalism=$row_count;

                       $sql='SELECT id FROM registration where purpose="medic"';
                      $result = mysqli_query($con, $sql);
                      $row_count=mysqli_num_rows($result);
                      $purposeObj->medic=$row_count;

                       $sql='SELECT id FROM registration where purpose="business"';
                      $result = mysqli_query($con, $sql);
                      $row_count=mysqli_num_rows($result);
                      $purposeObj->business=$row_count;
                     
?>
<script type="text/javascript">
  var pie=<?php echo json_encode($purposeObj);?>;
