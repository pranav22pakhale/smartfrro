...
<script>
    ...
    {	
 	   ...
 	   var mobileNumber=$("#mobileNumber").val();
         ...
         if (/^\d{10}$/.test(mobileNumber)) {
      	  // value is correct 10 digits mobile no, should be used
        }
  	    else {
  	    alert("Invalid Mobile no; must be ten digits only!")
  	    mobileNumber.focus()
  	    return false;
  	    }
 	   ...
 	   else if($('#dob_dateformat').val()!='' && $('#date_of_birth').val()=='')
      {
		   alert(" Date of birth must not be blank.");
		   $('#date_of_birth').focus();
        ...
        {
 		   alert(" Sur name must not be blank.");
     	   $('#surname').focus();
     	   return false;    	  
     	}
 	   else if($('#given_name').val()=='')
        {
 	  ...
 	  else if($('#dob_dateformat').val()=='dateofbirth_date_formats')
      {
		   alert(" Date of birth Date Formats must not be blank.");
 	 ...
 	 else if($('#date_of_birth').val()=='')
     {
 	   ...
 	   else if($('#nationality').val()=='Select...')
        {
 ...
 function refresh_captcha(){
    ...
    $(document).ready(function(){
      ...
      else {alert("Error: Enter the Password!");
        return (false);
...
<link rel="stylesheet" type="text/css" href="v_screen.css"> 
    ...
    <form action="insertion_signup.php" name="applicationform" id="eregistration_id" method="POST">
              ...
              <div class="form-group col-sm-6">
                ...
                <input type="text" name="password" id="password" class="form-control" size="43" maxlength="50" autocomplete="OFF" placeholder="Enter Password" value="">
              </div>
